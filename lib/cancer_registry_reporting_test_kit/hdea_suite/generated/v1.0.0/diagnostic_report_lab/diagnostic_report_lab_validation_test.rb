...
module CancerRegistryReportingTestKit
  module HDEAV100
    class DiagnosticReportLabValidationTest < Inferno::Test
      ...
      title 'DiagnosticReport resources returned during previous tests conform to the US Core DiagnosticReport Profile for Laboratory Results Reporting profile'
      description %(
