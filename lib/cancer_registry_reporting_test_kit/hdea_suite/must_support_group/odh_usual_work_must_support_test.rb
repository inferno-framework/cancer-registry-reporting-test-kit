...
module CancerRegistryReportingTestKit
  module HDEAV100
    class OdhUsualWorkMustSupportTest < Inferno::Test
      ...
      title 'All must support elements are provided in the ODH Usual Work Observation resources returned'
      description %(
      ...
      def self.metadata
        @metadata ||= Generator::GroupMetadata.new(YAML.load_file(File.join(__dir__, '..', '..', 'generated', 'v1.0.0', 'odh_usual_work', 'metadata.yml'), aliases: true))
      end
