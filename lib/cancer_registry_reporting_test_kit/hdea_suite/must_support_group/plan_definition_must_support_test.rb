...
module CancerRegistryReportingTestKit
  module HDEAV100
    class PlanDefinitionMustSupportTest < Inferno::Test
      ...
      title 'All must support elements are provided in the PlanDefinition resources returned'
      description %(
      ...
      def self.metadata
        @metadata ||= Generator::GroupMetadata.new(YAML.load_file(File.join(__dir__, '..', '..', 'generated', 'v1.0.0', 'plan_definition', 'metadata.yml'), aliases: true))
      end
