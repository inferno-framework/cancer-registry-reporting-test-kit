...
module CancerRegistryReportingTestKit
  module HDEAV100
    class ObservationLabGroup < Inferno::TestGroup
      title 'Observation US Core Laboratory Result Tests'
...
The US Core Observation US Core Laboratory Result sequence verifies that the system under test is
...
read succeeds.
      ...
      def self.metadata
        @metadata ||= Generator::GroupMetadata.new(YAML.load_file(
                                                     File.join(__dir__, 'observation_lab',
