...
module CancerRegistryReportingTestKit
  module HDEAV100
    class DiagnosticReportLabGroup < Inferno::TestGroup
      title 'DiagnosticReport US Core for Laboratory Results Reporting Tests'
...
The US Core DiagnosticReport US Core for Laboratory Results Reporting sequence verifies that the system under test is
...
read succeeds.
      ...
      def self.metadata
        @metadata ||= Generator::GroupMetadata.new(YAML.load_file(
                                                     File.join(__dir__, 'diagnostic_report_lab',
