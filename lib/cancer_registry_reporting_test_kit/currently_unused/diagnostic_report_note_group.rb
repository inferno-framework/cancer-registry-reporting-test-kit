...
module CancerRegistryReportingTestKit
  module HDEAV100
    class DiagnosticReportNoteGroup < Inferno::TestGroup
      title 'DiagnosticReport US Core for Report and Note Exchange Tests'
...
The US Core DiagnosticReport US Core for Report and Note Exchange sequence verifies that the system under test is
