...
module CancerRegistryReportingTestKit
  module HDEAV100
    class MedicationRequestGroup < Inferno::TestGroup
      title 'Cancer-Related Medication Request Tests'
      short_description 'Verify support for the server capabilities required by the Cancer-Related Medication Request Profile.'
      description %(
  # Background

The US Core Cancer-Related Medication Request sequence verifies that the system under test is
able to provide correct responses for MedicationRequest queries. These queries
must contain resources conforming to the Cancer-Related Medication Request Profile as
...
the [Cancer-Related Medication Request Profile](http://hl7.org/fhir/us/mcode/StructureDefinition/mcode-cancer-related-medication-request). Each element is checked against
