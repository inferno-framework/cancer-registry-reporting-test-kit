...
module CancerRegistryReportingTestKit
  class EHRMedicationRequestTests < Inferno::TestGroup
    title 'Medication Request Search Tests'
    description %(
      The mCode Medication Request sequence verifies that the system under test is
    able to provide correct responses for MedicationRequest queries. These queries
    must support resources conforming to the mCode MedicationRequest Profile as
    specified in the Central Cancer Registry Reporting v1.0.0 Implementation Guide.
    ...
    * patient + intent (order)
    ...
    the [mCode Medication Request Profile](http://hl7.org/fhir/us/mcode/STU3/StructureDefinition-mcode-cancer-related-medication-request.html). Each element is checked against
