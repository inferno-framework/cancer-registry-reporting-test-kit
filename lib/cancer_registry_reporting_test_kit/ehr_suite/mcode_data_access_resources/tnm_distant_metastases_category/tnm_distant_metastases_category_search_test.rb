...
module CancerRegistryReportingTestKit
    class TNMDistantMetastasesCategorySearchTest < Inferno::Test
      ...
      input :tnm_distant_metastases_category_category,
        title: 'Category of TNM Distant Metastases Category'
      ...
      run do
        ...
        @manual_search_params = [tnm_distant_metastases_category_category]
        run_search_test
      end
