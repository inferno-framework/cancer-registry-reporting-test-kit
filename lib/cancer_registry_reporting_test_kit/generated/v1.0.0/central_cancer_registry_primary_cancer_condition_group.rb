...
module CancerRegistryReportingTestKit
  module HDEAV100
    class CentralCancerRegistryPrimaryCancerConditionGroup < Inferno::TestGroup
      title 'Condition Central Cancer Registry Reporting Primary Cancer Tests'
      short_description 'Verify support for the server capabilities required by the Central Cancer Registry Reporting Primary Cancer Condition.'
      description %(
  # Background

The US Core Condition Central Cancer Registry Reporting Primary Cancer sequence verifies that the system under test is
able to provide correct responses for Condition queries. These queries
must contain resources conforming to the Central Cancer Registry Reporting Primary Cancer Condition as
