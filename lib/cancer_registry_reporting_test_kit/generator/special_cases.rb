    ...
    module SpecialCases
      class << self
        def move_ms_and_validation(ig_metadata)
          ms_group_metadata = CancerRegistryReportingTestKit::Generator::GroupMetadata.new({name: "must_support", class_name: "MustSupportSequence", resource: "MustSupport", reformatted_version: "v100", version: "v1.0.0", title: 'Must Support'})
          validation_group_metadata = CancerRegistryReportingTestKit::Generator::GroupMetadata.new({name: "must_support", class_name: "MustSupportSequence", resource: "Validation", reformatted_version: "v100", version: "v1.0.0", title: 'Validation'})
