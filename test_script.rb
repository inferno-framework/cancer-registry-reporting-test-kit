require 'inferno'
require_relative 'lib/cancer_registry_reporting_test_kit'
...
bundle = File.read('spec/fixtures/ccrr_hdea_content_bundle_example_with_multiple_resources.json')
bundle_model = FHIR.from_contents(bundle)

CancerRegistryReportingTestKit::HDEABundleParse::parse_bundle(bundle_model)